...
if (array_key_exists('update', $_GET)) {
    $output = `sudo /usr/bin/touch web/app-disabled`;
    ...
    $output .= `sudo /bin/rm web/app-disabled`;
}
...
if (array_key_exists('deploy', $_GET)) {
    $output = `sudo /usr/bin/touch web/app-disabled`;
    $output .= `/usr/bin/touch web/app-disabled && cd /var/www/juvem && /usr/bin/npm install && /usr/bin/grunt deploy && /bin/rm web/app-disabled`;
    $output .= `sudo /bin/chown www-data:erik -R /var/www/juvem`;
    $output .= `sudo /bin/chmod ug+rw -R /var/www/juvem`;
    $output .= `sudo /bin/rm web/app-disabled`;
}
